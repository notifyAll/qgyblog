...
;			}
	...
	public static String addData(String content, Object[] datas){
		String[] contents = content.split("X");
		String result = contents[0];
		for(int i = 1; i < contents.length; i++){
			result += datas[i-1]==null?"null":datas[i-1].toString()+ contents[i];
		}
		return result;
	}
	...
	public static String generatedRandomPassword(){
		...
		result.append(letter.charAt(random.nextInt(25) + 26));
		...
		for(int i = 0; i < 4; i++){
			result.append(letter.charAt(random.nextInt(25)));
		}
    ...
    public static void main(String[] arg){
        ...
        System.out.println(IDCardValidate("33032419890109210x"));
