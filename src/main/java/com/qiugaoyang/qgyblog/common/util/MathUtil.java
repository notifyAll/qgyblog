...
public class MathUtil {
	...
	public static String format(String num, int preision){
		return String.format("%."+String.valueOf(preision)+"f", string2Double(num));
	}
	 ...
	 * @return
	 */
	public static String dealIntegerAmount(String amount){
		return dealIntegerAmount(string2Double(amount));
	}
	 ...
	 * @return
	 */
	public static String dealIntegerAmount(double amount){
	 ...
	 * @return
	 */
	public static String dealIntegerAmount(int amount){
	 ...
	 * @return
	 */
	public static String dealDecimalAmount(String amount){
		return dealDecimalAmount(string2Double(amount));
	}
	 ...
	 * @return
	 */
	public static String dealDecimalAmount(double amount){
